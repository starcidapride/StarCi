...
import { calcReverse, calcBalance, calRound } from '@utils/calc.utils'
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-3">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            isInvalid={formik.touched.token0MaxAmount && formik.errors.token0MaxAmount ? true : false}
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={formik.handleChange}
                                            onBlur={formik.handleBlur}
                                            isInvalid={formik.touched.token1MaxAmount && formik.errors.token1MaxAmount ? true : false}
                                ...
                                <div className="mt-6">  
                                    <div className="flex items-start gap-4">
                                        <div className="flex-1">
                                            <Card>
                                                ...
                                                <CardBody>
                                                    <div className="items-center flex gap-4">
                                                        ...
                                                        <Input
                                                            ...
                                                            onChange={formik.handleChange}
                                                            onBlur={formik.handleBlur}
                                                            isInvalid={formik.touched.token1MinPrice && formik.errors.token1MinPrice ? true : false}
                                                        />
                                                        <Button onClick={() => formik.setFieldValue('token1MinPrice', formik.values.token1MinPrice + 1)} isIconOnly radius="full" className="flex-none" size="sm">
                                                ...
                                                <CardFooter className="p-4">
                                                    <div className="text-center w-full text-sm">
                                                        {!finishLoad ? '' : (!reverse
                                                            ? <Fragment> {calRound(formik.values.token1MinPrice, 3)} <span className="font-bold">{formik.values.isToken0Sell ? token0Symbol : token1Symbol}</span> per <span className="font-bold">{formik.values.isToken0Sell ? token1Symbol : token0Symbol}</span> </Fragment> 
                                            ...
                                            {
                                                formik.touched.token1MinPrice && formik.errors.token1MinPrice
                                        ...
                                        <div className="flex-1">          
                                            <Card>
                                                ...
                                                <CardBody>
                                                    <div className="items-center flex gap-3">
                                                        ...
                                                        <Input
                                                            ...
                                                            onChange={formik.handleChange}
                                                            onBlur={formik.handleBlur}
                                                            isInvalid={formik.touched.token1MaxPrice && formik.errors.token1MaxPrice ? true : false}
                                                        />
                                                        <Button onClick={() => formik.setFieldValue('token1MaxPrice', formik.values.token1MaxPrice + 1)} isIconOnly radius="full" className="flex-none" size="sm">
                                                            <PlusIcon height={16} width={16} />
                                                        </Button>
                                                ...
                                                <CardFooter className="p-4">
                                                    <div className="text-center w-full text-sm">
                                                        {!finishLoad ? '' : (!reverse
                                                            ? <Fragment> {calRound(formik.values.token1MaxPrice, 3)} <span className="font-bold">{formik.values.isToken0Sell ? token0Symbol : token1Symbol}</span> per <span className="font-bold">{formik.values.isToken0Sell ? token1Symbol : token0Symbol}</span> </Fragment> 
                                            ...
                                            {
                                                formik.touched.token1MaxPrice && formik.errors.token1MaxPrice
