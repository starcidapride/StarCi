...
export const SelectToken = (props: SelectTokenProps) => {
    ...
    return (
        <Fragment>
            ...
            variant="flat"
            > {tokenSymbol ? tokenSymbol : 'Select'} </Button>
            <Modal isOpen={isOpen} onOpenChange={onOpenChange} isDismissable={false}>
                <ModalContent>
                    <form onSubmit={formik.handleSubmit}>
                        <ModalHeader className="p-5 font-bold text-base">Select Token</ModalHeader>
                        <Divider />
                                                ...
                                                <Card isPressable key={coinProps.address} className="col-span-1"
                                                    onClick={
                                                        () => {
                                                            ...
                                                            if (formik.values.tokenAddress !=  coinProps.address){
                                                                setSyncToken(true)
                                                            }
